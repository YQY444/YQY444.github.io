...
const i18n = {
    zh: {
        ...
        "award1.prize": "国家级一等奖",
        "award1.desc": "数学学科基础竞赛，经过东华大学初赛（二等奖）、上海赛区复赛选拔，最终获得国家级一等奖。竞赛考察数学分析、高等代数、解析几何等基础数学知识的综合应用能力。",
        "award.initial": "初赛二等奖",
        "award.final": "国家级一等奖",
        "award.national": "国家级一等奖",
        "award.awardList": "获奖名单",
    ...
    en: {
        ...
        "award.initial": "Preliminary Second Prize",
        "award.final": "National First Prize",
        "award.national": "National First Prize",
        "award1.title": "2025 Chinese Mathematics Competitions (CMC)",
        "award1.prize": "National First Prize",
        "award1.desc": "Basic mathematics competition, passed Donghua University preliminary (Second Prize) and Shanghai regional selection, finally won national first prize.",
